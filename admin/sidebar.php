<div class="sidebar-nav">
    ...
    <li data-popover="true" data-placement="right">
        <a href="#" data-target=".posts" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> Posts<i class="fa fa-collapse"></i></a>
    </li>
    <li>
        <ul class="posts nav nav-list collapse">
            <li ><a href="all_posts.php"><span class="fa fa-caret-right"></span> All Posts</a></li>
            <li ><a href="add_new_post.php"><span class="fa fa-caret-right"></span> Add New Post</a></li>
        </ul>
    </li>
    <!-- All Posts End -->
    ...
    <li data-popover="true" data-content="Items in this group require a <strong><a href='http://portnine.com/bootstrap-themes/aircraft' target='blank'>premium license</a><strong>." rel="popover" data-placement="right">
        <a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> Premium Features<i class="fa fa-collapse"></i></a>
    </li>
    <li>
        ...
        <li><ul class="accounts-menu nav nav-list collapse">
            <li ><a href="sign-in.php"><span class="fa fa-caret-right"></span> Sign In</a></li>
